...
import com.example.qrsystem.View.User.Userpassword;
...
public class DeliveryLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.getSupportActionBar().setTitle("快递员登录");
    ...
    void settingbtn(){
        ...
        Login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ("".equals(usernamemsg) || "".equals(passwordmsg)){
                    ToastUtil toastUtil = new ToastUtil(DeliveryLoginActivity.this,"信息不能为空");
                    toastUtil.show(500);
                    return;
                }
        ...
        Exit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(DeliveryLoginActivity.this, MainActivity.class);
        ...
        Getpass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //查询密码，返回密码
                Intent intent = new Intent(DeliveryLoginActivity.this , Deliverypassword.class);
                startActivity(intent);
                ToastUtil toastUtil = new ToastUtil(DeliveryLoginActivity.this,"忘记密码");
                toastUtil.show(500);
            }
        });
        ...
        Register.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                System.out.println("快递员注册");
                //用户注册
                Intent intent = new Intent(DeliveryLoginActivity.this, Deliveryregister.class);
                startActivity(intent); //跳转
                ToastUtil toastUtil = new ToastUtil(DeliveryLoginActivity.this,"快递员注册");
                toastUtil.show(500);
            }
        });
    }
    ...
    void checkinfor(String usernamemsg , String passwordmsg){
        ...
        String path = basepath + "/delivery/login?username=" + usernamemsg + "&password=" + passwordmsg;
        try {
            ...
            if(connection.getResponseCode() == HttpURLConnection.HTTP_OK){
                ...
                if(result.equals("1")){    //登陆成功，跳转到首页
                    ...
                    Log.i(TAG,"登录成功");
                    System.out.println(usernamemsg +  " 用户登录成功");
                    Intent intent = new Intent(DeliveryLoginActivity.this, Delivery.class);
