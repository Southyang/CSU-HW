...
import com.example.qrsystem.View.Manager.Managerregister;
...
public class Deliveryregister extends AppCompatActivity {
    ...
    private String TAG = "Deliveryregister";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.getSupportActionBar().setTitle("快递员注册");
        ...
        registerbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ("".equals(usernamemsg) || "".equals(passwordmsg)){
                    ToastUtil toastUtil = new ToastUtil(Deliveryregister.this,"信息不能为空");
                    toastUtil.show(500);
                    return;
                }
    ...
    void register(String usernamemsg , String passwordmsg){
        ...
        String path = basepath + "/delivery/register?username=" + usernamemsg + "&password=" + passwordmsg;
        try {
            ...
            if(connection.getResponseCode() == HttpURLConnection.HTTP_OK){
                ...
                if(result.equals("success")){    //登陆成功，跳转到登录界面
                    ...
                    Log.i(TAG,"注册成功");
                    System.out.println("快递员注册成功");
                    Intent intent = new Intent(Deliveryregister.this, UserLoginActivity.class);
