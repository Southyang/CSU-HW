...
import com.example.qrsystem.View.Delivery.Deliveryregister;
...
public class ManagerLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.getSupportActionBar().setTitle("管理员登录");
    ...
    void settingbtn() {
        ...
        Login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ("".equals(usernamemsg) || "".equals(passwordmsg)) {
                    ToastUtil toastUtil = new ToastUtil(ManagerLoginActivity.this, "信息不能为空");
                    toastUtil.show(500);
                    return;
                }
        ...
        Getpass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //查询密码，返回密码
                Intent intent = new Intent(ManagerLoginActivity.this, Managerpassword.class);
                startActivity(intent);
                ToastUtil toastUtil = new ToastUtil(ManagerLoginActivity.this, "忘记密码");
                toastUtil.show(500);
            }
        });
        ...
        Register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //用户注册
                Intent intent = new Intent(ManagerLoginActivity.this, Managerregister.class);
                startActivity(intent); //跳转
                ToastUtil toastUtil = new ToastUtil(ManagerLoginActivity.this, "管理员注册");
                toastUtil.show(500);
            }
        });
    }
    ...
    void checkinfor(String usernamemsg, String passwordmsg) {
        ...
        String path = basepath + "/manager/login?username=" + usernamemsg + "&password=" + passwordmsg;
        try {
            ...
            if (connection.getResponseCode() == HttpURLConnection.HTTP_OK) {
                ...
                if (result.equals("1")) {    //登陆成功，跳转到首页
                    ...
                    Intent intent = new Intent(ManagerLoginActivity.this, Manager.class);
    ...
    ArrayList<String> getlist() {
        try {
            ...
            String path = basepath + "/manager/selectAllqrid";//获取全部的快递信息
            ...
            if (connection.getResponseCode() == HttpURLConnection.HTTP_OK) {
                ...
                for (int i = 0; i < length; i++) {
                    obj.add("快递单号:" + jo.getString("id" + i));
                }
                return obj;
            } else {
                Log.i(TAG, "连接失败");
