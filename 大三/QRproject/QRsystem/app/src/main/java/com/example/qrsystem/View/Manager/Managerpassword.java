...
public class Managerpassword extends AppCompatActivity {
    ...
    private String TAG = "Managerpassword";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.getSupportActionBar().setTitle("管理员-找回密码");
        ...
        forgetbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ("".equals(usernamemsg)){
                    ToastUtil toastUtil = new ToastUtil(Managerpassword.this,"信息不能为空");
                    toastUtil.show(500);
                    return;
                }
    ...
    void forgetpassword(String usernamemsg){
        ...
        String path = basepath + "/manager/forgetpassword?username=" + usernamemsg;
        try {
