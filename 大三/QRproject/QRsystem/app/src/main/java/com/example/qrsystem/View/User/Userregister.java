...
public class Userregister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.getSupportActionBar().setTitle("用户注册");
        ...
        registerbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ("".equals(usernamemsg) || "".equals(passwordmsg)){
                    ToastUtil toastUtil = new ToastUtil(Userregister.this,"信息不能为空");
                    toastUtil.show(500);
                    return;
                }
    ...
    void register(String usernamemsg , String passwordmsg){
        ...
        String path = basepath + "/user/register?username=" + usernamemsg + "&password=" + passwordmsg;
        try {
