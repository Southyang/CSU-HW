...
public class Deliverypassword  extends AppCompatActivity {
    private Button forgetbtn;
    private EditText username;
    private TextView forgetinfor;
    private String TAG = "Deliverypassword";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.getSupportActionBar().setTitle("快递员-找回密码");
        ...
        forgetbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ("".equals(usernamemsg)){
                    ToastUtil toastUtil = new ToastUtil(Deliverypassword.this,"信息不能为空");
                    toastUtil.show(500);
                    return;
                }
    ...
    void forgetpassword(String usernamemsg){
        ...
        String path = basepath + "/delivery/forgetpassword?username=" + usernamemsg;
        try {
